...
/**
 * A map-backed [Settings] for tests, so `AppPreferences` can be exercised without a platform
 * store (and without pulling in the `multiplatform-settings-test` artifact).
 */
